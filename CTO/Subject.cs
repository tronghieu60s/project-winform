...
namespace project_winform.CTO
{
    class Subject
    {
        ...
        public Subject(string idSubject, string name, int credit, string information, string lecturerName, DateTime startDay, DateTime endDay, Faculty faculty, Course course)
        {
